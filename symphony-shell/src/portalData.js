/* Per-product "full portal" navs — the deep Site Manager nav each product opens
   when you click its "full portal" link in the Symphony launcher. EDR mirrors the
   production screenshot; IES and SafeSend use their real full-portal link sets. */
import {
  ...
  ScrollText, Radar, FileText, ShieldCheck,
