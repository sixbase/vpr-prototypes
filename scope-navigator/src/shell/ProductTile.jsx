...
export function OverviewTile({ size = 32, className, style }) {
  return (
    <svg width={size} height={size} viewBox="1 0.5 32 32" fill="none" className={className} style={{ display: 'block', ...style }} aria-hidden="true">
      <path d="M1 8.5C1 4.08172 4.58172 0.5 9 0.5H25C29.4183 0.5 33 4.08172 33 8.5V24.5C33 28.9183 29.4183 32.5 25 32.5H9C4.58172 32.5 1 28.9183 1 24.5V8.5Z" style={{ fill: 'var(--vds-midnight-800)' }} />
